...
knitr::include_graphics('images/hme_flowchart_cut.png')
```
...
knitr::include_graphics('images/table_functions.png')
```
...
knitr::include_graphics('images/SEIRSdiagram.png')
```
...
knitr::include_graphics('images/infection_rate.png')
```
...
```{r, set-example-params, fig.height=10, fig.width=10}
example_params <- c(
  b = 1/(60*365),
  mu = 1/(76*365),
...
```{r, example-tip, rtip1, eval = FALSE, echo = FALSE}
...
``{r, higher-epsilon, fig.height=8, fig.width=8}
...
``{r, lower-recovery, fig.height=8, fig.width=8}
...
knitr::include_graphics('images/LHS.png')
```
...
``` {r, onedex, echo = FALSE, out.width = "60%", fig.cap='Our one-dimensional function. The grey line represents the function; the black points are the only points we are allowed to consider when building the emulator.'}
knitr::include_graphics('images/1dExample.png')
```
...
``` {r, onedemfirst, echo = FALSE, out.width = "60%", fig.cap='The predictions from our emulator with prior specifications as above. Red lines indicate 2-sigma bounds on the predictions (black line).'}
knitr::include_graphics('images/1dExampleEmUnadjust.png')
```
...
``` {r, onedemsecond, echo = FALSE, out.width = "60%", fig.cap='Predictions from the data-adjusted emulator above. Red lines indicate 2-sigma bounds on the predictions (black line), and the location of training points are shown.'}
knitr::include_graphics('images/1dExampleEmAdjust.png')
```
...
```{r, plot-em, fig.width = 9, fig.height = 7}
...
```{r, plot-actives-all, fig.width = 7, fig.height = 7}
...
```{r, check-effect-strength, fig.width = 7, fig.height = 7}
...
```{r, em-plot-viz, fig.height = 7, fig.width = 10}
...
```{r, plot-imp, fig.width = 7, fig.height = 6}
...
```{r, plot-imps, fig.height=7, fig.width= 10}
...
``{r, plot-nimp, fig.width = 7, fig.height = 6}
...
``{r, plot-second-imp, fig.width = 7, fig.height = 6}
...
``{r, restrict-ems, fig.width = 9, fig.height = 9}
...
``{r, plot-restricted-ems, fig.width = 7, fig.height = 7}
...
```{info, title = "R tip", collapsible = FALSE}
...
```{r, valid-diag-single, fig.width = 9, fig.height = 3, eval=F}
vd <- validation_diagnostics(ems_wave1$R200, validation = validation, targets = targets, plt=TRUE,
                             row = 1)
```

```{r, valid-diag-explicit, fig.width = 10, fig.height = 3.5, echo=F}
op <- par(mfrow = c(1, 3))
...
```{r, modify-sigma, fig.width = 10, fig.height = 10, eval=F}
...
```{r, modify-sigma2, fig.width = 10, fig.height = 3.5, echo=F}
sigmadoubled_emulator <- ems_wave1$R200$mult_sigma(2)
op <- par(mfrow = c(1, 3))
...
``{r, explore-sigma, fig.width = 10, fig.height = 10, eval=F}
...
``{r, explore-sigma2, fig.width = 10, fig.height = 3.5, echo=F}
tinysigma_emulator <- ems_wave1$R200$mult_sigma(0.1)
op <- par(mfrow = c(1, 3))
...
``{r, big-sigma, fig.width = 10, fig.height = 10, eval=F}
...
``{r, big-sigma2, fig.width = 10, fig.height = 3.5, echo=F}
hugesigma_emulator <- ems_wave1$R200$mult_sigma(10)
op <- par(mfrow = c(1, 3))
...
knitr::include_graphics('images/LHSamp.png')
```
...
knitr::include_graphics('images/LineSamp.png')
```
...
knitr::include_graphics('images/ImpSamp.png')
```
...
knitr::include_graphics('images/FinalSamp.png')
```
...
```{r, gen-new-points, fig.width = 9, fig.height = 9}
restricted_ems <- ems_wave1[c(1,2,3,4,7,8,9,10)]
...
```{r, plot-new-points, fig.width = 9, fig.height = 9}
...
knitr::include_graphics('images/wave0SEIReval.png')
```

with the model output at points in `new_points_restricted`

``` {r, echo = FALSE, out.width = "75%"}
knitr::include_graphics('images/wave1SEIReval.png')
```
...
``{r, gen-new-points-all, fignewpts, fig.width = 9, fig.height = 9}
...
```{r, space-rem, fig.width = 10, fig.height = 8}
...
``{r, task-diag, fig.height = 10, fig.width = 10}
...
``{r, task-inflate, fig.height = 10, fig.width = 10}
...
``{r, task-new-valid, fig.height = 10, fig.width = 10}
vd <- validation_diagnostics(ems_wave1, validation = validation, targets = targets, plt=TRUE)
``
...
``{r, task-gen-new, fig.height = 10, fig.width = 10}
new_points <- generate_new_design(ems_wave1, 180, targets, verbose = TRUE)
plot_wrap(new_points, ranges)
``
...
``{r, wave2-diag, fig.width = 10, fig.height = 10}
...
Note that the automated diagnostics have performed some variance inflation, as for instance we can see with the `I100` output:
  ...
  ``{r, wave2-plot, fig.height = 7, fig.width = 7}
...
``{r, new-validation, fig.width = 10, fig.height = 10}
...
``{r, prop-new-points-task, fig.width = 9, fig.height = 9}
...
```{r, wave-points, fig.width = 9, fig.height = 9}
...
```{r, sim-plot, fig.width = 9, fig.height = 9}
...
```{solution}
``{r, sim-plot-task, fig.width = 9, fig.height = 9}
...
```{r, wave-values, fig.width = 9, fig.height = 9}
